...
5. **新增 (v2.8.3)**: 检查 `memory.md` 行数，若 >100 则触发压缩。
...
- **通过合并重复或摘要冗余条目来压缩超限文件**（v2.8.3 Bug #3 修复）
- **完成后截断 memory.md 至最新 100 行**（v2.8.3 Bug #4 修复）
...
- **新增**: 压缩前触发 `before_compaction` Hook 生成草稿
