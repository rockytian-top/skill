...
```bash
git add -A
git commit -m "v2.6.0: 更新说明"
git tag v2.6.0 -m "v2.6.0"
...
| 文件 | 字段 | 要求 |
|------|------|------|
| SKILL.md | `version` | v2.6.0 |
| _meta.json | `version` | v2.6.0 |
| CHANGELOG.md | 最新版本 | v2.6.0 |
| git tag | tag名 | v2.6.0 |
...
- [x] SKILL.md: version = 2.6.0
- [x] _meta.json: version = 2.6.0
