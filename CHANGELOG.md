...
### Documentation
- **QUICKSTART.md** - 全新 30 秒快速入门指南
  - 自动写入机制完整流程图
  - 触发条件表格（失败 2 次→搜索→成功→写入→晋升）
  - 实际场景示例（Nginx 502、公众号 OCR）
  - 验证步骤 + 并发测试说明
- **README.md / README_EN.md** - 新增 "🤖 自动写入机制" 特性
- **learning.md** - 详细说明自动写入流程、锁机制、命名空间规则
- **operations.md** - 典型使用场景、自动 vs 手动对比表
- **setup.md** - 验证安装增加自动写入测试步骤

### 文档改进
- 所有文档版本号统一为 2.8.4
- 补充自动写入功能的触发条件、执行步骤、安全特性
- 增加命令行验证示例和调试技巧
